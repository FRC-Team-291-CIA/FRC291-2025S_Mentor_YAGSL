...
public class RobotContainer
{
  ...
  SwerveInputStream driveAngularVelocity = SwerveInputStream.of(drivebase.getSwerveDrive(),
                                                            ...
                                                            .withControllerRotationAxis(() -> driverJoystick.getHID().getRawAxis(driverConstants.kAxisLeftX))
   ...
   */
  SwerveInputStream driveDirectAngle = driveAngularVelocity.copy().withControllerHeadingAxis(() -> driverJoystick.getHID().getRawAxis(driverConstants.kAxisRightX),
  ...
  private void configureBindings()
  {
    ...
    {
      driverJoystick.button(driverConstants.kButtonStart).onTrue(Commands.runOnce(() -> drivebase.resetOdometry(new Pose2d(3, 3, new Rotation2d()))));
    ...
    if (DriverStation.isTest())
    {
      ...
      driverJoystick.button(driverConstants.kButtonX).whileTrue(Commands.runOnce(drivebase::lock, drivebase).repeatedly());
      driverJoystick.button(driverConstants.kButtonY).whileTrue(drivebase.driveToDistanceCommand(1.0, 0.2));
      driverJoystick.button(driverConstants.kButtonStart).onTrue((Commands.runOnce(drivebase::zeroGyro)));
      driverJoystick.button(driverConstants.kButtonBack).whileTrue(drivebase.centerModulesCommand());
      driverJoystick.button(driverConstants.kButtonLeftBumper).onTrue(Commands.none());
    ...
    } else
    {
      ...
      driverJoystick.button(driverConstants.kButtonLeftBumper).whileTrue(Commands.runOnce(drivebase::lock, drivebase).repeatedly());
      driverJoystick.button(driverConstants.kButtonRightBumper).onTrue(Commands.none());
    }
