...
public class RobotContainer {
  ...
  SwerveInputStream driveAngularVelocity = SwerveInputStream.of(drivebase.getSwerveDrive(),
      ...
      .withControllerRotationAxis(() -> driverJoystick.getHID().getRawAxis(driverConstants.kAxisRightX) * -1)
  ...
  SwerveInputStream driveDirectAngle = driveAngularVelocity.copy()
      .withControllerHeadingAxis(() -> driverJoystick.getHID().getRawAxis(driverConstants.kAxisRightX),
  ...
  private void configureBindings() {
    ...
    if (DriverStation.isTest()) {
      ...
      driverJoystick.button(driverConstants.kButtonX)
